...
class Constant(SizedRefOrConst):
    ...
    def __init__(
        self,
        name,
        value: Union[int, "Constant", "BaseNode"],
        attributes: "dict[ConstAttribute, list[BaseNode]]",
        size=None,
        signed=False,
    ):
...
class RangeSpec:
    ...
    def __init__(
        self,
        upper_base: ValOrConst,
        lower_base: ValOrConst = None,
        upper_power: ValOrConst = 1,
        lower_power: ValOrConst = 1,
    ):
