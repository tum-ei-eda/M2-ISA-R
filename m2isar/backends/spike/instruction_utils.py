...
data_type_map = {arch.DataType.S: "int", arch.DataType.U: "uint", arch.DataType.NONE: "void"}
...
class CodeString:
    ...
    def __init__(self, code, size, signed, regs_affected=None, line_infos=[]):
        self.code = code
...
class TransformerContext:
    """Track miscellaneous information throughout the code generation process."""
    ...
    def __init__(
        ...
        attributes: "list[arch.InstrAttribute]",
