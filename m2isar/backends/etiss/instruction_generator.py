...
def generate_functions(core: arch.CoreDef, static_scalars: bool, decls_only: bool, generate_coverage: bool, omit_comments: bool):
	...
	for fn_name, fn_def in core.functions.items():
		...
		context = instruction_utils.TransformerContext(core.constants, core.memories, core.memory_aliases, fn_def.args, fn_def.attributes,
			core.functions, 0, core_default_width, core_name, static_scalars, core.intrinsics, generate_coverage, True, omit_comments)
...
def generate_instruction_callback(core: arch.CoreDef, instr_def: arch.Instruction, fields, static_scalars: bool, block_end_on: BlockEndType, generate_coverage: bool, omit_comments: bool):
	patch_model(instruction_transform)
	...
	context = instruction_utils.TransformerContext(core.constants, core.memories, core.memory_aliases, instr_def.fields, instr_def.attributes,
		core.functions, enc_idx, core_default_width, core_name, static_scalars, core.intrinsics, generate_coverage, False, omit_comments)
...
def generate_instructions(core: arch.CoreDef, static_scalars: bool, block_end_on: BlockEndType, generate_coverage: bool, omit_comments: bool):
	...
	for (code, mask), instr_def in core.instructions.items():
		...
		callback_str = generate_instruction_callback(core, instr_def, fields, static_scalars, block_end_on, generate_coverage, omit_comments)
